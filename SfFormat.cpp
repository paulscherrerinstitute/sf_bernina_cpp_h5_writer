...
class SfFormat : public H5Format
{
    ...
    public:
        ...
        SfFormat()
        {
            ...
            {
                {config::raw_image_dataset_name, "data/JF_1.5M/data"},
                {"pulse_id", "data/JF_1.5M/pulse_id"},
                {"frame", "data/JF_1.5M/frame"},
                {"is_good_frame", "data/JF_1.5M/is_good_frame"},
                {"missing_packets_1", "data/JF_1.5M/missing_packets_1"},
                {"missing_packets_2", "data/JF_1.5M/missing_packets_2"},
                {"daq_recs", "data/JF_1.5M/daq_recs"},
                {"daq_rec", "data/JF_1.5M/daq_rec"},
                {"framenum_diff", "data/JF_1.5M/framenum_diff"},
                {"pulse_ids", "data/JF_1.5M/pulse_ids"},
                {"framenums", "data/JF_1.5M/framenums"},
                {"pulse_id_diff", "data/JF_1.5M/pulse_id_diff"},
                {"module_number", "data/JF_1.5M/module_number"},
            }));
